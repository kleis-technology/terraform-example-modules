...
The configuration returns the [AMI ID](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AMIs.html) of the latest
debian trixie version and the rendered configuration script for the http server.
